package com.autohall.lpbuilderapi.exceptions;

import com.autohall.lpbuilderapi.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, "Data integrity conflict", request.getRequestURI(), null);
    }
